...
pub struct IDT {
    ...
    pub stack_segment_fault: Gate<InterruptHandlerWithErr>,
...
pub type InterruptHandler = extern "x86-interrupt" fn(InterruptStack);
pub type InterruptHandlerWithErr = extern "x86-interrupt" fn(InterruptStack, error_code: u64);
pub type PageFaultHandler = extern "x86-interrupt" fn(InterruptStack, error_code: PageFaultErr);
